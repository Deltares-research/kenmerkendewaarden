...
def test_calc_wltidalindicators(df_ext_12_2010_2014):
    ...
    hw_monthmax_permonth_expected = np.array([1.94, 1.89, 1.86, 1.55, 1.74, 1.58, 1.54, 2.07, 2.11, 2.06, 1.9 ,
    ...
    lw_monthmin_permonth_expected = np.array([-1.33, -1.05, -1.05, -1.06, -1.12, -1.11, -1.07, -0.92, -0.96,
    ...
    hw_monthmax_mean_peryear_expected = np.array([1.8325    , 1.72166667, 1.74083333, 1.83166667, 1.75666667])
    lw_monthmin_mean_peryear_expected = np.array([-1.0625    , -1.07666667, -1.0775    , -1.13333333, -1.09083333])
    hw_monthmin_mean_peryear_expected = np.array([0.55416667, 0.60166667, 0.5975    , 0.53833333, 0.66416667])
    lw_monthmax_mean_peryear_expected = np.array([-0.04916667,  0.05583333, -0.02416667,  0.03      ,  0.00416667])
